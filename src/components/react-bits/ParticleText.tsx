...
/*
 * Vendored from React Bits (https://reactbits.dev/r/ParticleText-TS-TW),
 ...
 *   2. `prefers-reduced-motion` — the caller does not mount it, and renders
 *      the heading as ordinary type instead.
 *
 * The thing to know before using this anywhere: it draws the text into a
 * `<canvas>`. The words are pixels, not glyphs — they cannot be selected,
 * searched, translated, resized by a browser zoom that reflows, or read by a
 * screen reader, and a crawler sees an empty box. So it is only ever
 * decoration here, `aria-hidden`, with a real heading element carrying the
 * same words underneath it. See `v3-hero.tsx`.
 */
