 ...
 * `textColor` as props rather than hard-coding a dark palette, and it pads
 * every phrase to the width of the longest one, so the board cannot reflow the
 * line under it. It is the best-behaved component in the set.
 */
